...
<template>
    <GuestLayout>
        ...
        <div class="mb-8">
            ...
            <p class="text-slate-500 font-medium">Bergabunglah dengan MegaMart dan mulai belanja!</p>
        </div>

        <form @submit.prevent="submit" class="space-y-5">
            <div class="space-y-2">
                <InputLabel for="name" value="Nama Lengkap" class="text-xs font-bold uppercase tracking-wider text-slate-500 ml-1" />
            ...
            <div class="space-y-2">
                <InputLabel for="email" value="Alamat Email" class="text-xs font-bold uppercase tracking-wider text-slate-500 ml-1" />
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    />
                    <button type="button" @click="showPasswordConfirmation = !showPasswordConfirmation" class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-blue-600 transition-colors">
